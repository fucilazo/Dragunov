...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Usage: /home/spark-1.6.1-bin-hadoop2.4/bin/spark-submit --driver-memory 2g KDD_spark.py max_k corrected")
        sys.exit(1)
    ...
    cluster_assignments_sample = standardized_data_values.map(
        lambda datum: str(best_model.predict(datum)) + "," + ",".join(map(str, datum)))
